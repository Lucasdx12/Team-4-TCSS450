package edu.uw.tcss450lucasd12.team_4_tcss450.services;
...
import edu.uw.tcss450lucasd12.team_4_tcss450.AuthenticationActivity;
...
public class PushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // In the WS (Web Service), you define what gets sent. You can change it there to suit your needs.
        // Then here on the Android side, decide what to do with the message you got!

        /* The Web Service is only sending chat messages so the type will always be msg
         * So change later to include different types of push messages later on.
         * Perform logic/routing based on the "type"
         * Feel free to change the key or type of values. */
        String typeOfMessage = intent.getStringExtra("type");
        ChatRoom message = null;
        int chatId = -1;
        try {
            message = ChatRoom.createFromJsonString(intent.getStringExtra("message"));
        ...
        if (appProcessInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND ||
            ...
            // Research more on notifications and how to display them.
